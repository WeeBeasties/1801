...
A total of `r length(myData$COMPETENCY)` registrations have been completed as of `r format(Sys.Date(),format="%B %d, %Y")`. This includes a total of `r length(unique(myData$COURSE))` different courses. The distribution of the registrations between the eight core competencies is shown in figure \@ref(fig:plotByCompetency).
...
Here, I am attempting to embed a shiny app into this bookdown document.

`r knitr::include_app("https://www.cliftonfranklund.com/shiny/Dashboard/", height = "500px")`
